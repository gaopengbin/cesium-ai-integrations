...
2. Copy the skill content from [SKILL.md](../../../skills/cesium-context7/SKILL.md) to `.github/skills/cesium-context7/SKILL.md`
...
2. Copy the skill content from [SKILL.md](../../../skills/cesium-context7/SKILL.md) to `.claude/skills/context7/SKILL.md`
